...
class PostWrapperView extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('../controllers/PostWrapperController')
  ...
  render() {
    const proxies = Controller !== PostWrapperView ? transformProxies(this.props.children) : {
